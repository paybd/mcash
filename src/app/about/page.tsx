        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-white/85 max-w-xl">
              Mcash Remit তৈরি হয়েছে সাশ্রয়ী, দ্রুত এবং নির্ভরযোগ্য আন্তর্জাতিক পেমেন্টের প্রতিশ্রুতি নিয়ে।
            </p>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-neutral-50 shadow-2xl ring-1 ring-black/5 p-6 sm:p-8">
            ...
            <p className="mt-3 text-neutral-700">
              আফ্রিকা, ইউরোপ ও এশিয়ায় বিস্তৃত টিম নিয়ে Mcash Remit আজ বৈধ, দ্রুত এবং সাশ্রয়ী পেমেন্টের জন্য একটি বিশ্বস্ত প্ল্যাটফর্ম। আমরা সেরা রেট, চমৎকার সাপোর্ট এবং স্মার্ট টেকনোলজির সমন্বয়ে আপনাকে সেরা অভিজ্ঞতা দেওয়ার চেষ্টা করি।
            </p>
          </div>
        </div>
      </section>
