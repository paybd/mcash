      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <Image src="/assets/mcash.png" alt="Mcash Remit" width={40} height={40} className="object-contain bg-amber-50 rounded-md p-1" />
            <span className="text-lg font-semibold hidden sm:block">Mcash Remit</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-white/90">
            ...
            <Link href="/mcash_remit_2026.apk" className="rounded-lg bg-white text-[#196642] px-4 py-2 text-sm font-semibold hover:bg-white/90 transition">ডাউনলোড</Link>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4 border-t border-white/20">
            <nav className="flex flex-col gap-2 pt-4">
              ...
              <Link href="/mcash_remit_2026.apk" onClick={closeMenu} className="px-4 py-2 text-sm text-center rounded-lg bg-white text-[#196642] font-semibold hover:bg-white/90 transition">ডাউনলোড</Link>
            </nav>
          </div>
        )}
      </div>
